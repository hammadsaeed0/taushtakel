...
const forgetPassword = ({ navigation }) => {
  ...
  return (
    <ScrollView style={{flex: 1, backgroundColor:'#ffffff',}} contentContainerStyle={{flexGrow:1}}>
      ...
      <Text style={{fontSize:18, fontFamily:'Montserrat-Bold', marginTop:20, color:'black'}}>Change Password</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{width:'30%',paddingLeft:10, justifyContent:'center'}}>
      ...
      <TouchableOpacity style={{width:'85%', height:50, marginTop:"30%", alignSelf:'center' , borderRadius:5, backgroundColor:'#20AC73', justifyContent:'center', alignItems:'center', elevation:5}} onPress={()=> navigation.navigate('Login')}>
        <Text style={{color:'#ffffff', fontFamily:'Montserrat-Bold', fontSize:18}}>Update Password</Text>
      </TouchableOpacity>
